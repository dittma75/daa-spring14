...
/**
 * DP_solver attempts to satisfy a Conjunctive Normal Form formula with the
 * Davis-Putnam backtracking algorithm.
 *
...
public class DP_solver
{
    ...
    /**
     * Returns true if the formula has no clauses left to satisfy, false
     * otherwise.
     *
     * @param f is the formula passed to be checked
    ...
    /**
     * Set given variable to given true/false value. Variable value may be
